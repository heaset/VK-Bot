				...
				switch($this->type){
					...
					case Config::JSON:
					    try {
					        ...
					        MainLogger::getLogger()->warning("[json_decode] Произошла ошибка {$e->getMessage()} в файле {$this->file}, ошибка json сериализации");
                        }
						break;
					case Config::YAML:
						...
						try {
						    ...
						    MainLogger::getLogger()->warning("[yaml_parse] Произошла ошибка {$exception->getMessage()} в файле {$this->file}, ошибка yaml сериализации");
                        }
						break;
